  ...
  return (
    <div style={{minHeight:'100vh',background:'#060d1a',padding:'1.5rem',maxWidth:'900px',margin:'0 auto'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:'12px',marginBottom:'1.5rem'}}>
        <div style={{background:'linear-gradient(135deg,rgba(37,99,235,.2),rgba(37,99,235,.05))',border:'1px solid rgba(37,99,235,.3)',borderTop:'3px solid #2563eb',borderRadius:'16px',padding:'1.25rem'}}>
          <div style={{fontSize:'24px',marginBottom:'4px'}}>👥</div>
          <div style={{fontSize:'12px',color:'rgba(255,255,255,.5)',marginBottom:'4px',textTransform:'uppercase',letterSpacing:'.5px'}}>Total Users</div>
          <div style={{fontSize:'36px',fontWeight:800,color:'#60a5fa'}}>{statsLoading ? '...' : s.totalUsers ?? '—'}</div>
          <div style={{fontSize:'11px',color:'#34d399',marginTop:'4px'}}>+{statsLoading ? '...' : s.newUsersThisWeek ?? 0} this week</div>
        </div>
        <div style={{background:'linear-gradient(135deg,rgba(16,185,129,.2),rgba(16,185,129,.05))',border:'1px solid rgba(16,185,129,.3)',borderTop:'3px solid #10b981',borderRadius:'16px',padding:'1.25rem'}}>
          <div style={{fontSize:'24px',marginBottom:'4px'}}>⭕</div>
          <div style={{fontSize:'12px',color:'rgba(255,255,255,.5)',marginBottom:'4px',textTransform:'uppercase',letterSpacing:'.5px'}}>Total Circles</div>
          <div style={{fontSize:'36px',fontWeight:800,color:'#34d399'}}>{statsLoading ? '...' : s.totalCircles ?? '—'}</div>
          <div style={{fontSize:'11px',color:'#34d399',marginTop:'4px'}}>{statsLoading ? '...' : s.activeCircles ?? 0} active</div>
        </div>
        <div style={{background:'linear-gradient(135deg,rgba(245,158,11,.2),rgba(245,158,11,.05))',border:'1px solid rgba(245,158,11,.3)',borderTop:'3px solid #f59e0b',borderRadius:'16px',padding:'1.25rem'}}>
          <div style={{fontSize:'24px',marginBottom:'4px'}}>💳</div>
          <div style={{fontSize:'12px',color:'rgba(255,255,255,.5)',marginBottom:'4px',textTransform:'uppercase',letterSpacing:'.5px'}}>Total Payments</div>
          <div style={{fontSize:'36px',fontWeight:800,color:'#fbbf24'}}>{statsLoading ? '...' : s.totalPayments ?? '—'}</div>
          <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginTop:'4px'}}>transactions</div>
        </div>
        <div style={{background:'linear-gradient(135deg,rgba(167,139,250,.2),rgba(167,139,250,.05))',border:'1px solid rgba(167,139,250,.3)',borderTop:'3px solid #8b5cf6',borderRadius:'16px',padding:'1.25rem'}}>
          <div style={{fontSize:'24px',marginBottom:'4px'}}>💰</div>
          <div style={{fontSize:'12px',color:'rgba(255,255,255,.5)',marginBottom:'4px',textTransform:'uppercase',letterSpacing:'.5px'}}>Total Saved</div>
          <div style={{fontSize:'36px',fontWeight:800,color:'#a78bfa'}}>${statsLoading ? '...' : s.totalSaved ?? '0'}</div>
          <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginTop:'4px'}}>across all circles</div>
        </div>
      </div>

      <div style={{background:'rgba(255,255,255,.04)',border:'1px solid rgba(255,255,255,.08)',borderTop:'3px solid #10b981',borderRadius:'14px',padding:'1.25rem',marginBottom:'1.25rem'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'12px',marginBottom:'12px'}}>
          <div style={{background:'rgba(16,185,129,.08)',border:'1px solid rgba(16,185,129,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            ...
            <div style={{fontSize:'22px',fontWeight:700,color:'#34d399'}}>${statsLoading ? '...' : (stripe.monthRevenue || 0).toFixed(2)}</div>
          </div>
          <div style={{background:'rgba(16,185,129,.08)',border:'1px solid rgba(16,185,129,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginBottom:'4px'}}>Payments This Month</div>
            <div style={{fontSize:'22px',fontWeight:700,color:'#34d399'}}>{statsLoading ? '...' : stripe.thisMonthPayments ?? 0}</div>
          </div>
          <div style={{background:'rgba(16,185,129,.08)',border:'1px solid rgba(16,185,129,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginBottom:'4px'}}>Total Revenue</div>
            <div style={{fontSize:'22px',fontWeight:700,color:'#34d399'}}>${statsLoading ? '...' : (stripe.totalRevenue || 0).toFixed(2)}</div>
          </div>
        </div>
        <a href="https://dashboard.stripe.com" target="_blank" rel="noopener noreferrer" style={{display:'block',textAlign:'center',fontSize:'12px',color:'#60a5fa',textDecoration:'none'}}>View Stripe dashboard →</a>
      </div>

      <div style={{background:'rgba(255,255,255,.04)',border:'1px solid rgba(255,255,255,.08)',borderTop:'3px solid #2563eb',borderRadius:'14px',padding:'1.25rem',marginBottom:'1.25rem'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'12px',marginBottom:'12px'}}>
          <div style={{background:'rgba(37,99,235,.08)',border:'1px solid rgba(37,99,235,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            ...
            <div style={{fontSize:'22px',fontWeight:700,color:'#60a5fa'}}>{statsLoading ? '...' : ses.emailsSent24h ?? 0}</div>
          </div>
          <div style={{background:'rgba(37,99,235,.08)',border:'1px solid rgba(37,99,235,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginBottom:'4px'}}>This Week</div>
            <div style={{fontSize:'22px',fontWeight:700,color:'#60a5fa'}}>{statsLoading ? '...' : ses.emailsSentWeek ?? 0}</div>
          </div>
          <div style={{background:'rgba(37,99,235,.08)',border:'1px solid rgba(37,99,235,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginBottom:'4px'}}>This Month</div>
            <div style={{fontSize:'22px',fontWeight:700,color:'#60a5fa'}}>{statsLoading ? '...' : ses.emailsSentMonth ?? 0}</div>
          </div>
        </div>
        <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:'12px'}}>
          <div style={{background:'rgba(16,185,129,.08)',border:'1px solid rgba(16,185,129,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginBottom:'4px'}}>Emails Left Today</div>
            <div style={{fontSize:'22px',fontWeight:700,color:'#34d399'}}>{statsLoading ? '...' : emailsLeft.toLocaleString()}</div>
          </div>
          <div style={{background:'rgba(16,185,129,.08)',border:'1px solid rgba(16,185,129,.15)',borderRadius:'10px',padding:'12px',textAlign:'center'}}>
            <div style={{fontSize:'11px',color:'rgba(255,255,255,.4)',marginBottom:'4px'}}>Daily Limit</div>
            <div style={{fontSize:'22px',fontWeight:700,color:'#34d399'}}>{statsLoading ? '...' : (ses.max24HourSend || 50000).toLocaleString()}</div>
          </div>
        </div>
        <div style={{textAlign:'center',marginTop:'10px',fontSize:'11px',color:'rgba(16,185,129,.7)'}}>✓ Production mode · {ses.maxSendRate || 14} emails/second</div>
      </div>
